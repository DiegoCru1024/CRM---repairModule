...
import stylesB from "./repairRequestPlatform.module.scss";
  ...
  useEffect(() => {
    const fetchReclamos = async () => {
      try {
        ...
        switch (tipoFeedBack) {
          case "Reclamo":
            response = await api.get('/reclamos/area/4')
          ...
          case "Queja":
            ...
            break;
          case "Solicitud":
            response = await api.get('/solicitudes/area/4')
          ...
          <div className='principalModuloRQS'>
              ...
              <div className='tableContainer'>
                  <>
                    ...
                    <div className={styles.loadingRQS}>Cargando datos...</div>
                    }
                  </>
              </div>
          </div>
